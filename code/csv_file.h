...
public:
	...
	//--------------------------------------------------
	// ヘッダーの設定
	// 引数1  : string	str	/ ヘッダー名
	// 引数2  : char delim	/ 区切り文字
	//--------------------------------------------------
	void SetHeader(string str, char delim);

	//--------------------------------------------------
	// インデックスの設定
	// 引数1  : string	str	/ インデックス名
	// 引数2  : char delim	/ 区切り文字
	//--------------------------------------------------
	void SetIndex(string str, char delim);
	...
	// 引数2  : int	line		/ 列番号
	//--------------------------------------------------
	void SetCell(string str, int row, int line);

	//--------------------------------------------------
	// 行数の所得
	// 返値   : int	   / 行数
	//--------------------------------------------------
	int GetRowSize(void) { return cell.size(); }
	...
	// 返値   : string		/ データ
	//--------------------------------------------------
	void SetData(string str,int row, int line) { cell.at(row).at(line) = str; }
	...
	// 返値   : string	 / データ
	//--------------------------------------------------
	string GetData(int row, int line) { return cell.at(row).at(line); }
